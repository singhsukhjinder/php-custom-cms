		        ...
		        <div class="container">
		            <div class="row">
		                <div class="col-md-12 text-center">
		                    <h1 class="page-title">jee main </h1>
		                    <ul>
		                        <li>
		...
		<div class="single-blog-details sec-spacer">
			<div class="container" style="padding-bottom:50px;">
				<div class="row">
					<div class="col-lg-12 col-md-12">
						...
						<?php
							$sql = "SELECT * FROM classescontent WHERE class='jeemain'";
			...
			<div class="row justify-content-center text-center">
				<div class="col-md-12 justify-content-center"><h1 class=" justify-content-center text-center" style="text-transform:uppercase">Syllabus</h1></div>
					...
					<?php
						$sql = "SELECT DISTINCT subject FROM syllabus WHERE class='jeemain'";
						$res = mysqli_query($conn,$sql) or die($conn->error);
						if (mysqli_num_rows($res) >= 1 ) {
							while ($row = mysqli_fetch_assoc($res)) {
								...
								$sql1 = "SELECT * FROM syllabus WHERE class='jeemain' AND subject='$row[subject]'";
