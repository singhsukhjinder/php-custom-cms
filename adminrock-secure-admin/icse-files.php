...
?>        
        <?php 
          ...
          $sql = "SELECT * FROM  syllabus WHERE class='icse' ORDER BY subject";
          $res = mysqli_query($conn,$sql) or die($conn->error);
        ?>
        <div id="content">
          <div id="content-header">
            <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="#" class="current">Add Syllabus</a> <a href="#" class="current">jee main</a> <a href="#" class="current">icse files</a> </div>
            <h1>icse files</h1>
          </div>
                            ...
                            if (mysqli_num_rows($res) >= 1 ) {
                              ...
                              while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                if($row['subject'] != ''){ 
                                  ...
                                  <td class="center"><a href="icse-files.php?action=delete&id='.$row['id'].'">Delete</a></<td>
                                  </tr>';
                                }
                            }
                          }
