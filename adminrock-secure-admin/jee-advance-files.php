...
?>        
        <?php 
          ...
          $sql = "SELECT * FROM  syllabus WHERE class='jeeadvance' ORDER BY subject";
          $res = mysqli_query($conn,$sql) or die($conn->error);
        ?>
        <div id="content">
          <div id="content-header">
            <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="#" class="current">JEE-Advance</a> <a href="#" class="current">JEE-Advaced Files</a> </div>
            <h1>JEE-Advaced Files</h1>
          </div>
                            ...
                            if (mysqli_num_rows($res) >= 1 ) {
                              ...
                              while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                if($row['subject'] != ''){ 
                                  ...
                                  <td class="center"><a href="jee-advance-files.php?action=delete&id='.$row['id'].'">Delete</a></<td>
                                  </tr>';
                                }
                            }
                          }
