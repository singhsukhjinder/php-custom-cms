		        ...
		        <div class="container">
		            <div class="row">
		                <div class="col-md-12 text-center">
		                    <h1 class="page-title">CLASS 12th </h1>
		                    <ul>
		                        <li>
		...
		<div class="single-blog-details sec-spacer">
			<div class="container" style="padding-bottom:50px;">
				<div class="row">
					<div class="col-lg-12 col-md-12">
						...
						<?php
							$sql = "SELECT * FROM classescontent WHERE class='12th'";
			...
			<div class="row justify-content-center text-center">
				<div class="col-md-12 justify-content-center"><h1 class=" justify-content-center text-center"style="text-transform: uppercase;">Syllabus</h1></div>
					...
					<?php
						$sql = "SELECT DISTINCT subject FROM syllabus WHERE class='12th'";
						$res = mysqli_query($conn,$sql) or die($conn->error);
						if (mysqli_num_rows($res) >= 1 ) {
							while ($row = mysqli_fetch_assoc($res)) {
								...
								$sql1 = "SELECT * FROM syllabus WHERE class='12th' AND subject='$row[subject]'";
												...
												<div class="borderred">
													<div class="row">
														<div class="col-sm-12 col-md-6 col-lg-6 mb-sm-3">
															<img src="uploads/class'.$row1['class'].'/'.$row1['placehldrimg'].'" alt="Download" width="100">
														</div>
														<div class="col-sm-12 col-md-6 col-lg-6 filename">'.$dt[0].'<br><br>
															<a href="uploads/class'.$row1['class'].'/'.$row1['filename'].'"  download="'.$row1['filename'].'" class="">
