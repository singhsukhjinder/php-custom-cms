...
<!-- Mirrored from keenitsolutions.com/products/html/edulearn/edulearn-demo/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Sep 2018 11:25:34 GMT -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h1 class="page-title">STATE BOARD</h1>
                        <ul>
                            <li>
                    ...
                    <div class="col-md-4">
                        <div class="contact-inner">
                            ...
                            <p class="contact-desc">
                                STUDYROCKS, CORPORATE OFFICE SCF 5,<br> GTB NAGAR, JALANDHAR, PUNJAB
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="contact-inner">
                            ...
                            <p class="contact-desc">
                                0181-507-2918<br> 0181-297-6308
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="contact-inner">
                            ...
                            <p class="contact-desc">
                                support@studyrocks.in<br> www.studyrocks.in
                            </p>
                        </div>
                    </div>
                </div>
